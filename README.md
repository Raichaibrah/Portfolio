# Raïcha Sanoussi : Portfolio

Welcome to the source for my personal portfolio website hosted at:
...
- 📄 **Download CV (PDF):** linked on the CV section of the site :contentReference[oaicite:2]{index=2}  
...
### **EasyPrescription**  
Web app for submitting prescriptions; backend built with Python and Django, data managed with SQL. :contentReference[oaicite:9]{index=9}
